...
class user_frame(tk.Frame):   #继承frame类
    ...
    def require_user_data(self):
        self.send=network_send_message(self.service_socket,require_data_type().user_name_updata_type())
    ...
    def message_update(self):
        ...
        try:
            ...
            if self.message['Head']=='message':
                ...
                #更新联系人
                self.active_user=self.message['ActiveUserList']
                self.whole_user=self.message['WholeUserList']
...
class message_frame(tk.Frame):
    ...
    def send_messsage_command(self):
        ...
        try:
            network_message(self.service_socket).send_message(self.dict)
        except:
